...
const Button = class {
  constructor(hostRef) {
    ...
    this.handleClick = ev => {
      ...
      } else if ((0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_2__.m)(this.el)) {
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el);
  }
