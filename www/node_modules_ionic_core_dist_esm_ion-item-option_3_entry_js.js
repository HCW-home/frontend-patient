...
/* harmony import */ var _index_50cd649f_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-50cd649f.js */ 7584);
...
const ItemOptions = class {
  ...
  render() {
    const mode = (0,_ionic_global_04e268e7_js__WEBPACK_IMPORTED_MODULE_2__.b)(this);
    const isEnd = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_4__.o)(this.side);
    return (0,_index_1a99aeb7_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_1a99aeb7_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      class: {
        [mode]: true,
...
const ItemSliding = class {
  ...
  connectedCallback() {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.contentEl = (0,_index_50cd649f_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this2.el);
  ...
  open(side) {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      side = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_4__.o)(side) ? 'end' : 'start';
  ...
  updateOptions() {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (let i = 0; i < options.length; i++) {
        ...
        const side = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_4__.o)(option.side) ? 'end' : 'start';
  ...
  onStart() {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_50cd649f_js__WEBPACK_IMPORTED_MODULE_5__.d)(contentEl);
    }
  ...
  onEnd(gesture) {
    ...
    if (contentEl) {
      (0,_index_50cd649f_js__WEBPACK_IMPORTED_MODULE_5__.r)(contentEl, initialContentScrollY);
    }
