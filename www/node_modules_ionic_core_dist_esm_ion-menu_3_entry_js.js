...
/* harmony import */ var _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-91800b86.js */ 6267);
/* harmony import */ var _overlays_58857b11_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-58857b11.js */ 5890);
...
const Menu = class {
  constructor(hostRef) {
    ...
    this.handleFocus = ev => {
       ...
       */
      const lastOverlay = (0,_overlays_58857b11_js__WEBPACK_IMPORTED_MODULE_7__.k)(document);
  ...
  sideChanged() {
    this.isEndSide = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.o)(this.side);
  }
  ...
  connectedCallback() {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m._register(_this);
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.i)(this.el);
  }
  ...
  disconnectedCallback() {
    ...
    _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m._unregister(this);
  ...
  setOpen(shouldOpen, animated = true) {
    return _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m._setOpen(this, shouldOpen, animated);
  }
  ...
  loadAnimation() {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this4.animation = yield _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m._createAnimation(_this4.type, _this4);
  ...
  canStart(detail) {
    ...
    } else if (_index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m._getOpenSync()) {
      return false;
    }
  ...
  onStart() {
    if (!this.isAnimating || !this.animation) {
      (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.n)(false, 'isAnimating has to be true');
      return;
  ...
  onEnd(detail) {
    ...
    newStepValue += (0,_cubic_bezier_c313947a_js__WEBPACK_IMPORTED_MODULE_3__.g)([0, 0], [0.4, 0], [0.6, 1], [1, 1], (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, adjustedStepValue, 0.9999))[0] || 0;
  ...
  beforeAnimation(shouldOpen) {
    (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.n)(!this.isAnimating, '_before() should not be called while animating'); // this places the menu into the correct location before it animates in
  ...
  afterAnimation(isOpen) {
    ...
    (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.n)(this.isAnimating, '_before() should be called while animating'); // keep opening/closing the menu disabled for a touch more yet
  ...
  updateState() {
    ...
    if (!this.disabled) {
      _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m._setActiveMenu(this);
    }

    (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.n)(!this.isAnimating, 'can not be animating');
  }

  forceClosing() {
    (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.n)(this._isOpen, 'menu cannot be closed');
    this.isAnimating = true;
...
const updateVisibility = /*#__PURE__*/function () {
  var _ref = (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (menu) {
    const menuEl = yield _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m.get(menu);
...
const MenuButton = class {
  constructor(hostRef) {
    ...
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m.toggle(_this6.menu);
    });
  }
...
const MenuToggle = class {
  constructor(hostRef) {
    ...
    this.onClick = () => {
      return _index_91800b86_js__WEBPACK_IMPORTED_MODULE_6__.m.toggle(this.menu);
    };
  }
