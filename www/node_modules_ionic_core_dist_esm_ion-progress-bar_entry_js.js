...
const ProgressBar = class {
  ...
  render() {
    ...
    const paused = _ionic_global_04e268e7_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('_testing');
...
const renderProgress = (value, buffer) => {
  const finalValue = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_2__.l)(0, value, 1);
  const finalBuffer = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_2__.l)(0, buffer, 1);
  return [(0,_index_1a99aeb7_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
    part: "progress",
    class: "progress",
    style: {
