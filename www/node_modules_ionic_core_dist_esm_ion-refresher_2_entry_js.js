...
/* harmony import */ var _index_50cd649f_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-50cd649f.js */ 7584);
...
/* harmony import */ var _animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./animation-8d232782.js */ 4967);
...
const createBaseAnimation = pullingRefresherIcon => {
  ...
  const baseAnimation = (0,_animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__.c)().duration(1000).easing('ease-out');
  const spinnerArrowContainerAnimation = (0,_animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(spinnerArrowContainer).keyframes([{
    offset: 0,
    opacity: '0.3'
  }, {
    offset: 0.45,
  ...
  const circleInnerAnimation = (0,_animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(circle).keyframes([{
    offset: 0,
  ...
  const circleOuterAnimation = (0,_animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(spinner).keyframes([{
    offset: 0,
  ...
  if (arrowContainer && arrow) {
    const arrowContainerAnimation = (0,_animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(arrowContainer).keyframes([{
      offset: 0,
    ...
    const arrowAnimation = (0,_animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(arrow).keyframes([{
      offset: 0,
...
const createScaleAnimation = (pullingRefresherIcon, refresherEl) => {
  ...
  const spinnerAnimation = (0,_animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(pullingRefresherIcon).keyframes([{
    offset: 0,
...
const createSnapBackAnimation = pullingRefresherIcon => {
  return (0,_animation_8d232782_js__WEBPACK_IMPORTED_MODULE_7__.c)().duration(125).addElement(pullingRefresherIcon).fromTo('transform', 'translateY(var(--ion-pulling-refresher-translate, 100px))', 'translateY(0px)');
...
const handleScrollWhilePulling = (ticks, numTicks, pullAmount) => {
  ...
  (0,_index_1a99aeb7_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => {
    ticks.forEach((el, i) => {
      ...
      const progression = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, start / range, 1);
...
const translateElement = (el, value, duration = 200) => {
  ...
  const trans = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.t)(el, duration);
  (0,_index_1a99aeb7_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => {
...
const shouldUseNativeRefresher = /*#__PURE__*/function () {
  var _ref = (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (referenceEl, mode) {
    ...
    yield new Promise(resolve => (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.c)(refresherContent, resolve));
...
const Refresher = class {
  ...
  resetNativeRefresher(el, state) {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if ((0,_ionic_global_04e268e7_js__WEBPACK_IMPORTED_MODULE_2__.b)(_this2) === 'ios') {
        ...
        yield (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.t)(_this2.el.querySelector('.refresher-refreshing-icon'), 200);
      }
        ...
        (0,_index_1a99aeb7_js__WEBPACK_IMPORTED_MODULE_1__.f)(() => {
          ...
          if (scrollTop > 0) {
            ...
            /* Refreshing */
              ...
              const ratio = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, scrollTop / (refresherHeight * 0.5), 1);
          ...
          const pullAmount = _this3.progress = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, (Math.abs(scrollTop) - offset) / MAX_PULL, 1);
  ...
  setupMDNativeRefresher(contentEl, pullingSpinner, refreshingSpinner) {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const circle = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.g)(pullingSpinner).querySelector('circle');

      const pullingRefresherIcon = _this4.el.querySelector('ion-refresher-content .refresher-pulling-icon');

      const refreshingCircle = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.g)(refreshingSpinner).querySelector('circle');
      ...
      _this4.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-3f1a7d95.js */ 2172))).createGesture({
        ...
        onMove: ev => {
          ...
          _this4.progress = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, ev.deltaY / 180 * 0.5, 1);
        ...
        onEnd: ev => {
          ...
          (0,_index_1a99aeb7_js__WEBPACK_IMPORTED_MODULE_1__.c)( /*#__PURE__*/(0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  connectedCallback() {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const contentEl = _this6.el.closest(_index_50cd649f_js__WEBPACK_IMPORTED_MODULE_4__.I);

      if (!contentEl) {
        (0,_index_50cd649f_js__WEBPACK_IMPORTED_MODULE_4__.p)(_this6.el);
        return;
      }
      /**
      ...
      (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.c)(contentEl, /*#__PURE__*/(0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        const customScrollTarget = contentEl.querySelector(_index_50cd649f_js__WEBPACK_IMPORTED_MODULE_4__.b);
        /**
        ...
        _this6.scrollEl = yield (0,_index_50cd649f_js__WEBPACK_IMPORTED_MODULE_4__.g)(customScrollTarget !== null && customScrollTarget !== void 0 ? customScrollTarget : contentEl);
        /**
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this7.nativeRefresher) {
        ...
        if (!_this7.pointerDown) {
          (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.r)(() => (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.r)(() => _this7.resetNativeRefresher(_this7.elementToTransform, 32
          /* Completing */
          )));
        }
      } else {
    ...
    return (0,_home_olivierb_Developments_iabsis_hcw_patient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this8.nativeRefresher) {
        ...
        if (!_this8.pointerDown) {
          (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.r)(() => (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.r)(() => _this8.resetNativeRefresher(_this8.elementToTransform, 16
          /* Cancelling */
          )));
        }
      } else {
